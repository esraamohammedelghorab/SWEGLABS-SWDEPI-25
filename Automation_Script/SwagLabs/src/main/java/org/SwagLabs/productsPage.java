...
public class productsPage {
    ...
    public void removeFromCartTest() {
        WebDriverWait wait = new WebDriverWait(web, Duration.ofSeconds(10));
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("add-to-cart-sauce-labs-backpack"))).isDisplayed());
    ...
    @Test(priority = 5)
    public void convertButtonFromRemoveTest() throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(web, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("add-to-cart-sauce-labs-backpack"))).click();
        Thread.sleep(4000);
